...
\section{Secondo principio e temperatura assoluta}
...
\[-W=Q=Q_H+Q_L\]
dove $Q_H$ \`e il calore che il sistema acquista da una sorgente calda e $Q_L$ \`e il calore che acquista da una sorgente fredda\footnote{Di solito $Q_H$ \`e positivo e $Q_L$ \`e negativo.}. Notiamo che
